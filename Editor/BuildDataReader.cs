...
namespace StrangeToolkit
{
    ...
    public static class BuildDataReader
    {
        ...
        private static string buildLogPath = Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData), "Unity", "Editor", "Editor.log");
        ...
        public static BuildData ReadBuildLog()
        {
            ...
            {
                Debug.LogWarning("[Strange Toolkit] Could not find Unity Editor log file.");
                return null;
            }
            ...
            {
                Debug.LogWarning($"[Strange Toolkit] Failed to copy log file: {e.Message}");
                return null;
            }
            ...
            {
                Debug.LogWarning($"[Strange Toolkit] Error reading build log: {e.Message}");
                data = null;
            }
            finally
            {
